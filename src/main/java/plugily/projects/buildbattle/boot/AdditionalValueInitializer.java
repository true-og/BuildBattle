...
public class AdditionalValueInitializer {
    ...
    private void registerStatistics() {
        ...
        statsStorage.registerStatistic("BLOCKS_PLACED",
                new StatisticType("blocks_placed", true, "int(11) NOT NULL DEFAULT '0'"));
        statsStorage.registerStatistic("BLOCKS_BROKEN",
                new StatisticType("blocks_broken", true, "int(11) NOT NULL DEFAULT '0'"));
        statsStorage.registerStatistic("POINTS_HIGHEST",
                new StatisticType("points_highest", true, "int(11) NOT NULL DEFAULT '0'"));
        statsStorage.registerStatistic("POINTS_HIGHEST_WIN",
                new StatisticType("points_highest_win", true, "int(11) NOT NULL DEFAULT '0'"));
        statsStorage.registerStatistic("POINTS_TOTAL",
                new StatisticType("points_total", true, "int(11) NOT NULL DEFAULT '0'"));
        statsStorage.registerStatistic("PARTICLES_USED",
                new StatisticType("particles_used", true, "int(11) NOT NULL DEFAULT '0'"));
        statsStorage.registerStatistic("SUPER_VOTES",
                new StatisticType("super_votes", true, "int(11) NOT NULL DEFAULT '0'"));
        statsStorage.registerStatistic("LOCAL_POINTS",
                new StatisticType("local_points", false, "int(11) NOT NULL DEFAULT '0'"));
        statsStorage.registerStatistic("LOCAL_POINTS_GTB",
                new StatisticType("local_points_gtb", false, "int(11) NOT NULL DEFAULT '0'"));
        statsStorage.registerStatistic("REPORTS_TRIGGERED",
                new StatisticType("reports_triggered", false, "int(11) NOT NULL DEFAULT '0'"));
